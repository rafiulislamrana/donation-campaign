        ...
        <div>
            ...
            <div>
                <div className="hero" style={{ backgroundImage: 'url(https://i.ibb.co/0fq71Tx/Rectangle-4281.png)' }}>
                    ...
                    <div className="hero-content md:p-4 p-0 text-center text-neutral-content">
                        <div className="py-32 flex items-center gap-4 flex-col">
                            <h1 className="mb-5 text-3xl md:text-5xl text-[#0B0B0B] font-bold">I Grow By Helping People In Need</h1>
                            {/* <input type="text" />
            ...
            {/* All card section */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 py-20 max-w-6xl mx-auto px-3 lg:px-0">
                {
